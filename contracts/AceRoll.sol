...
// AceRoll helps your migrate your existing Uniswap LP tokens to AceSwap LP ones
contract AceRoll {
    ...
    function migrate(
        ...
        require(deadline >= block.timestamp, 'AceSwap: EXPIRED');
    ...
    function removeLiquidity(
        ...
        require(amountA >= amountAMin, 'AceRoll: INSUFFICIENT_A_AMOUNT');
        require(amountB >= amountBMin, 'AceRoll: INSUFFICIENT_B_AMOUNT');
    }
